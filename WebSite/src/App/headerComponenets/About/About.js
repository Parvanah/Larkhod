  ...
  return (
    <div id="all_section_about" className='all_section_about'>
      <div className="section_one_about">
        <div className="section_one_one_about">
          <img className="image_phone_one_about" src={img3} />
          <Link to="/home"><img className="selesh_phone_about" src={seleshfphon} /></Link>
        </div>
        <div className="section_one_two_about">
          <Link to="/home"><img className="selesh_about" src={selesh} /></Link>
          <img className="image_phone_logo_about" src={img1} />
      ...
      <div className="section_three_about">
        <div className="section_three_one_about" >
