    ...
    <div className='full-all-grade-n'>
      <div className="all-grade-N">
        <div className="flesh-image-grade-b">
          <Link to="/Header"><img src={image} /></Link>
        </div>
            ...
            <div className="button-grade-N" ref={top}>
              {primary.map((item) => {
                return (
                  ...
                  >
                    <div className="sanaf-grade-n"> <img  src={sanaf} /></div>
                    <div className="li-grade-b" onClick={() => setCurrentState(item.label)}>{item.label}</div>
                  </Link>
                );
              })}
            </div>
