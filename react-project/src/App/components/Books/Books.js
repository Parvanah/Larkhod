...
import image from "../../assets/Group_158_bu.png";
import laptop from "../../assets/dot_one.png";
    ...
    <div className="Books" id="Books">
      <div className="top">
        <div className="first-svgs">
         <Link to="/Grades"><img className="arrowSvg" src={image} /></Link>
