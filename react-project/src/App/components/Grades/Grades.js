    ...
    {grads.map((grad)=>(
     ...
     <h2>{grad.title}</h2>
      ...
      <div id="n_">
        ...
        <svg className="Union_1_dg" viewBox="-1920 -2161 1920 1078.565">
          <linearGradient
            id="Union_1_dg"
            spreadMethod="pad"
            x1="0.5"
          ...
          <path
            id="Union_1_dg"
            d="M 0 -1082.436279296875 L -12.62069988250732 -1082.436279296875 L -1919.999755859375 -1082.436279296875 L -1919.999755859375 -1099.329345703125 L -1919.999755859375 -2161 C -1915.80029296875 -2159.873046875 -1911.55419921875 -2158.716552734375 -1907.380004882812 -2157.56005859375 C -1604.134765625 -2073.616455078125 -1285.439086914062 -2030.727172851562 -959.9998779296875 -2030.057006835938 C -634.5606079101562 -2030.727172851562 -315.8649597167969 -2073.616455078125 -12.62069988250732 -2157.56005859375 C -8.445600509643555 -2158.716552734375 -4.200300216674805 -2159.873046875 0 -2161 L 0 -1099.329345703125 L 0 -1082.436279296875 L 0 -1082.435424804688 Z M -1919.999755859375 -1082.436279296875 L -1919.999755859375 -1082.435424804688 Z"
          ></path>
        </svg>
        <div id="Group_356">
          <img id="Group_355" src={images} />
        </div>
        <div>
          <span id="n_________">صنف‌های موجود</span>
          <br />
          <span id="n_____________">صنف مورد نظر خود را انتخاب کنید</span>
        </div>
        <div className="ul_high_school">
          {grades.map((item) => {
            return (
              <Link
                className="link_high_school"
                key={item.id}
                to="/books"
                state={{ subjects: item.subjects }}
              >
                <img className="sanaf" src={sanaf} />
                <div className="li_high_school">{item.grade}</div>
              </Link>
            );
          })}
        </div>
