...
<div id="change_profile_svg">
	<svg className='Rectangle_change_profile'>
		<linearGradient id="Rectangle_change_profile" spreadMethod="pad" x1="0.22" x2="0.905" y1="-0.035" y2="1.793">
			<stop offset="0" stop-color="#3c98bd" stop-opacity="1"></stop>
			<stop offset="1" stop-color="#0f53a1" stop-opacity="1"></stop>
		</linearGradient>
		<rect id="Rectangle_change_profile" rx="200" ry="200" x="0" y="0"  width="1366" height="566">
		</rect>
	</svg>
	<svg className='Ellipse_change_profile'>
		<ellipse id="Ellipse_change_profile" rx="60" ry="60" cx="129" cy="129">
		</ellipse>
	</svg>
