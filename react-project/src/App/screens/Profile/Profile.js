...
// 	</svg>
// 	<div id="Group_6">
// 		{/* <img id="Group_10" src="Group_10.png" srcset="Group_10.png 1x, Group_10@2x.png 2x"> */}
			
		
// 	</div>
// 	<div id="nm">
// 		<span>آپلود عکس نمایه</span>
// 	</div>
...
//                 <div className='details-of-massege'>               
//                     <div className='first'>
...
// 	{/* <div id="Text">
// 		<span></span>
//     style="font-family:Bahij Helvetica Neue;font-style:normal;font-weight:lighter;"
//     <span >نام</span>
// 	</div>
// 	<div id="n_">
// 		<span></span><span >ایمیل آدرس</span>
// 	</div>
// 	<div id="Text_">
// 		<span></span><span >تخلص</span>
// 	</div>
// 	<div id="Text_ba">
// 		<span></span><span >سن</span>
// 	</div>
// 	<div id="n__ba">
// 		<span></span><span >نام کاربری</span>
// 	</div>
// 	<div id="Text_bb">
// 		<span></span><span >صنف</span>
// 	</div>
// 	<svg className='Line_78' viewBox="0 0 430.381 1">
// 		<path id="Line_78" d="M 430.3814086914062 0 L 0 0">
// 		</path>
// 	</svg>
// 	<svg className='Line_81' viewBox="0 0 430.381 1">
// 		<path id="Line_81" d="M 430.3814086914062 0 L 0 0">
// 		</path>
// 	</svg>
// 	<svg className='Line_79' viewBox="0 0 430.381 1">
// 		<path id="Line_79" d="M 430.3814086914062 0 L 0 0">
// 		</path>
// 	</svg>
// 	<svg className='Line_82' viewBox="0 0 430.381 1">
// 		<path id="Line_82" d="M 430.3814086914062 0 L 0 0">
// 		</path>
// 	</svg>
// 	<svg className='Line_80' viewBox="0 0 430.381 1">
// 		<path id="Line_80" d="M 430.3814086914062 0 L 0 0">
// 		</path>
// 	</svg>
// 	<svg className='Line_83' viewBox="0 0 430.381 1">
// 		<path id="Line_83" d="M 430.3814086914062 0 L 0 0">
// 		</path>
// 	</svg>
// 	<svg className='Rectangle_268'>
// 		<rect onclick="application.goToTargetView(event)" id="Rectangle_268" rx="21.5" ry="21.5" x="0" y="0" width="430" height="43">
// 		</rect> 
// 	</svg>
// 	<div id="n__bg">
// 		<span></span>
//     style="font-family:Bahij Helvetica Neue;font-style:normal;font-weight:normal;"
//     <span >ذخیره کردن</span>
// 	</div>
// 	<div onclick="application.goToTargetView(event)" id="Group_412">
// 		<img id="Group_158" src="Group_158.png" srcset="Group_158.png 1x, Group_158@2x.png 2x">		
// 	</div> */}
// </div>
//     </div>
//   )
