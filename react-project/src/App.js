...
import Dari from './App/Zaban_Dari';
import Pashto from './App/Zaban_Pashto';
...
import Grads from './App/components/Grades/Grades'
  ...
  return (
    <Router>
      ...
      <Switch>
        ...
        <Route  path="/primary"><Grads/> </Route>
        <Route  path="/scondary"><Grads/> </Route>
        <Route  path="/high"><Grads/> </Route>

        <Route  path="/first_grade"><Books/> </Route>
        <Route  path="/second_grade"><Books/> </Route>
        <Route  path="/third_grade"><Books/></Route>
        <Route  path="/fourth_grade"><Books/></Route>
        <Route  path="/fifth_grade"><Books/></Route>
        <Route  path="/sixth_grade"><Books/></Route>
        <Route  path="/seventh_grade"><Books/></Route>
        <Route  path="/eighth_grade"> <Books/></Route>
        <Route  path="/ninth_grade"><Books/></Route>
        <Route  path="/tenth_grade"> <Books/> </Route>
        <Route  path="/eleventh_grade"> <Books/> </Route>
        <Route  path="/twelfth_grade"> <Books/> </Route>

        <Route  path="/art_first"> <Unit/> </Route>
        <Route  path="/hand_writing_first"> <Unit/> </Route>
        <Route  path="/islamic_hanafi_first"> <Unit/> </Route>
        <Route  path="/islamic_jafari_first"> <Unit/> </Route>
        <Route  path="/life_skill_first"> <Unit/> </Route>
        <Route  path="/Math_First"> <Unit/> </Route>
        <Route  path="/quran_first"> <Unit/> </Route>
        <Route  path="/dri_first"> <Unit/> </Route>
