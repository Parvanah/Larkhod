  ...
  return (
    <div>
      <ul>
        ...
        <li>
        <Link  to="./islamichanafi_eleven">(حنفی)تعلیم و تربیت اسلامی</Link>
        </li>
        <li>
        <Link   to="./islamicjafari_eleven">(جعفری)تعلیم و تربیت اسلام</Link>
        </li>
        <li>
        <Link   to="./math_eleven">ریاضی</Link>
        </li>
        <li>
        <Link  to="./physic_eleven">فزیک</Link>
        </li>
        <li>
        <Link   to="tafseer_eleven">تفسیر</Link>
        </li>
        <li>
        <Link   to="./dari_eleven">دری</Link>
        </li>
         <li>
        <Link   to="./pashto_eleven">پشتو</Link>
        </li>
    </ul> 
    </div>
  )
